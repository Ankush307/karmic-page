        ...
        <div className='relative pb-[60px]'>
            <div className="max-w-[1140px] mx-auto max-sm:px-5">
                <div className='pt-[96px] max-md:pt-[60px]'>
                    <h2 className='lg:text-[56px] text-white sm:text-[46px] text-[30px] font-light md:leading-[60px] leading-[50px] text-center uppercase relative'>Who is karmic? <span><img className='absolute pointer-events-none top-[-45%] left-[50%] translate-x-[-50%] max-sm:max-h-[77px] ' src="./assets/images/png/text-line.png" alt="text-line" /></span> </h2>
                    ...
                    <div className="flex items-center justify-center flex-wrap gap-4">
                        {BUILDERS_LIST.map((obj, i) => (
                            <div key={i}>
                                <img className='max-w-[369px] w-full border-[1px] border-white border-opacity-20 rounded-lg' src={obj.image} alt="builders" />
                            </div>
                        ))}
                    </div>
                </div>
