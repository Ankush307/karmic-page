...
const Services = () => {
    return (
        <div id="services" className="relative max-sm:pb-10">
                ...
                <div className="flex pt-[77px] max-lg:pt-16 max-md:pt-12 max-sm:pt-8 gap-y-10 flex-wrap">
                    {SERVICES_LIST.map((item, index) => (
                        <div className="w-4/12 px-[10.5px] max-lg:w-1/2 max-md:w-full justify-center" key={index}>
                            <div className="relative ball-card max-lg:overflow-hidden rounded-xl sm:max-w-[369px] mx-auto">
                                <div className={`relative transition-all duration-500 ease-linear cursor-pointer z-10 p-[22.22px] h-full lg:h-[276px] sm:max-w-[369px] mx-auto rounded-xl hover:backdrop-blur-[10px] hover:bg-white hover:bg-opacity-10 hover:drop-shadow-[0_4px_20px_rgba(0,0,0,15)`}>
                                    {item.logo}
