    ...
    return (
        <div id='about' className='md:pt-20 pt-10 md:pb-[136px] pb-16 relative'>
            <div className="container mx-auto max-w-[1180px]">
                <h2 className='lg:text-[56px] sm:text-[46px] text-[30px] font-light text-white md:leading-[60px] lg:pb-12 pb-6 leading-[50px] text-center uppercase relative'>UpComing Projects <span><img className='absolute top-[-20%] left-[50%] translate-x-[-50%] max-sm:max-h-[77px] pointer-events-none' src="./assets/images/png/text-line.png" alt="text line" /></span> </h2>
                ...
                <div className="w-full flex items-center justify-center">
                    <CustomButton text={'View All'} myClass={'border-[1px] text-center border-white bg-transparent py-3 px-8 text-white sm:mt-12 mt-8 font-medium max-w-[124px]'} />
                </div>
            </div>
