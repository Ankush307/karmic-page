...
const Values = () => {
    return (
        <div className='max-w-[1140px] mx-auto px-4 pt-8 pb-16'>
            ...
            <div className="flex pt-[77px] max-lg:pt-16 max-md:pt-12 max-sm:pt-8 gap-y-10 flex-wrap justify-center">
                {VALUES_LIST.map((item, index) => (
                    <div className="w-4/12 px-[10.5px] max-lg:w-1/2 max-md:w-full cursor-pointer" key={index}>
                        <div className="relative ball-card">
                            <div className={`relative z-10 sm:p-4 p-3 border-[1px] border-white border-opacity-10 transition-all duration-500 ease-linear sm:max-w-[369px] max-w-[330px] mx-auto rounded-xl hover:backdrop-blur-[10px] hover:bg-white hover:bg-opacity-10 hover:drop-shadow-[0_4px_20px_rgba(0,0,0,15)`}>
                                {item.logo}
